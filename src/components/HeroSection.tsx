...
const HeroSection = () => (
  <section className="relative py-24 bg-gradient-to-br from-soft-blue via-white to-soft-gray flex items-center justify-center min-h-[60vh]">
    <div className="flex flex-col items-center">
      ...
      <h1 className="font-playfair text-4xl font-bold text-vivid-purple mb-4 text-center">
        Oasis Medical Supply
      </h1>
